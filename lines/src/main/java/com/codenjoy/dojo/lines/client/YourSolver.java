...
public class YourSolver implements Solver<Board> {
    ...
    // this is your email
    private static final String USER_NAME = "kapitalinaivanovna@gmail.com";
    ...
    public static void main(String[] args) {
        WebSocketRunner.runOnServer("127.0.0.1:8080",  // "192.168.1.40:8080", // to use for local server
