...
public class LinesTest {
   ...
   //unnecessary because of new functionality
    ...
    @Test
    public void shouldChangeColorWhenThreeSameColorInLine_LeftBetweenVertical() {
        givenFl( " B  WBY Y " +
                        " YB WGG Y " +
                        " BY  WWY  " +
                        " YRBBYB   " +
    ...
    @Test
    public void shouldChangeColorWhenThreeSameColorInLine_LeftUpVertical() {
        givenFl( " B  WBY Y " +
                        " YB YGG Y " +
                        " BY YWWY  " +
                        " YRBGYB   " +
    ...
    @Test
    public void shouldChangeColorWhenThreeSameColorInLine_LeftDownVertical() {
        givenFl( " B Y      " +
                        " Y B W    " +
                        " BYGBWW   " +
                        " YYBY     " +
    ...
    @Test
    public void shouldChangeColorWhenThreeSameColorInLine_DownRightHorizontal() {
        givenFl( " B Y      " +
                        " Y B W    " +
                        " BYGBWW B " +
                        " YYBY     " +
    ...
    @Test
    public void shouldChangeColorWhenThreeSameColorInLine_DownLeftHorizontal() {
        givenFl( " B Y      " +
                        " Y W W    " +
                        " BYGBYW B " +
                        " YBBYR    " +
    ...
    @Test
    public void shouldChangeColorWhenThreeSameColorInLine_DownVertical() {
        givenFl( " B Y      " +
                        " Y W W    " +
                        " BYGBYW B " +
                        " YBBYR    " +
